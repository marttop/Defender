...
void init_info_texts(all_t *s_all)
{
    ...
    sfText_setPosition(s_all->s_info_text.title_c, s_all->s_info_text.pos_title);
    sfText_setPosition(s_all->s_info_text.castle_txt, s_all->s_info_text.pos_txt);
    sfText_setPosition(s_all->s_info_text.title_s, s_all->s_info_text.pos_title);
    sfText_setPosition(s_all->s_info_text.spawner_txt, s_all->s_info_text.pos_txt);
    sfText_setPosition(s_all->s_info_text.title_g, s_all->s_info_text.pos_title);
    sfText_setPosition(s_all->s_info_text.ground_txt, s_all->s_info_text.pos_txt);
